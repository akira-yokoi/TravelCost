...
NSString * const ISM_COLUMN_UNIT = @"unit";
NSString * const ISM_COLUMN_DATA_TYPE = @"data_type";
NSString * const ISM_COLUMN_INPUT_TYPE = @"input_type";
NSString * const ISM_COLUMN_INT_LENGTH = @"int_length";
NSString * const ISM_COLUMN_DECIMAL_LENGTH = @"decimal_length";
...
- (NSArray *)getValueColumnNames{
    return @[ ISM_COLUMN_NAME, ISM_COLUMN_UNIT, ISM_COLUMN_DATA_TYPE, ISM_COLUMN_INPUT_TYPE, ISM_COLUMN_INT_LENGTH, ISM_COLUMN_DECIMAL_LENGTH, ISM_COLUMN_DEFAULT_VALUE_TYPE, ISM_COLUMN_DEFAULT_VALUE, ISM_COLUMN_SELECT_ITEMS, ISM_COLUMN_CAN_UPDATE_FLAG, ISM_COLUMN_INPUT_ORDER_NUM, ISM_COLUMN_INPUT_FLAG, ISM_COLUMN_OUTPUT_ORDER_NUM, ISM_COLUMN_OUTPUT_FLAG, ISM_COLUMN_OUTPUT_SETTING];
}
